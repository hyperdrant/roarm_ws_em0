...
class UvToArmNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('fixed_z', 180.0)
        ...
        self.get_logger().info('Temporary mode: use u->x, v->y directly.')
    ...
    def on_uv(self, msg: Vector3):
        ...
        x_robot = clamp(u * 0.5, self.min_x, self.max_x)
        y_robot = clamp((v - 240.0) * 0.5, self.min_y, self.max_y)
